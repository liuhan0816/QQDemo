...
public class HandSocket {
    ...
    public HandSocket(ServerSocket socket, HashMap<String,User> userlist){
    ...
    //群发消息-已废弃
    public void send_to_all(User user,String s){
    ...
    public void privateChat(User user,String userName,String msg) throws IOException{
        ...
        printStream.println(curUser+"说:"+msg);
    }
